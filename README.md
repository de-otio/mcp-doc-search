...
- **Local embeddings**: auto-downloads `all-MiniLM-L6-v2` (ONNX) on first use, then works fully offline — no API key required; `multilingual-e5-small`, EmbeddingGemma and `nomic-embed-text-v1.5` are one setting away
